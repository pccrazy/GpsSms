...
public class Sms {
	...
	public boolean equals(Object o) {
		...
		else if (date != null ? !date.equals(sms.date) : sms.date != null) return false;
		else if (msg != null ? !msg.equals(sms.msg) : sms.msg != null) return false;
		else if (type != sms.type) return false;
